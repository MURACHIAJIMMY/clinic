...
//                         <button
//                           onClick={() =>
//                             startChat(appt.createdBy._id, appt._id)
//                           }
                  ...
                  <div className="flex flex-col items-end space-y-2">
                    ...
                    {user?.role === 'doctor' && (
                      <div className="flex flex-wrap gap-2 mt-1">
                        ...
                        {/* ✅ Safe check before accessing createdBy._id */}
                        {appt.createdBy && appt.createdBy._id && (
                          <button
                            onClick={() => startChat(appt.createdBy._id, appt._id)}
                            className="px-2 py-1 bg-blue-600 text-white text-xs rounded hover:bg-blue-700"
                          >
                            Message Patient
                          </button>
